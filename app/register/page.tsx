...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#e7efe9] p-4 md:p-6">
      <div className="mx-auto grid min-h-[calc(100vh-2rem)] max-w-[1400px] grid-cols-1 overflow-hidden rounded-[28px] border border-[#c8d3cc] bg-[#edf3ef] shadow-xl lg:grid-cols-5">
        ...
        <div className="flex items-center justify-center p-6 md:p-10 lg:col-span-2">
          <div className="w-full max-w-md space-y-8 rounded-3xl border border-[#c8d3cc] bg-[#f3f7f4] p-8 shadow-sm">
            <div>
