...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#e7efe9] p-3 sm:p-4 md:p-6">
      <div className="mx-auto grid min-h-[calc(100vh-1.5rem)] sm:min-h-[calc(100vh-2rem)] max-w-[1400px] grid-cols-1 overflow-hidden rounded-2xl sm:rounded-[28px] border border-[#c8d3cc] bg-[#edf3ef] shadow-xl lg:grid-cols-5">
        <div className="hidden items-center p-4 lg:col-span-3 lg:flex">
        ...
        <div className="flex items-center justify-center p-4 sm:p-6 md:p-10 lg:col-span-2">
          <div className="w-full max-w-md space-y-6 sm:space-y-8 rounded-2xl sm:rounded-3xl border border-[#c8d3cc] bg-[#f3f7f4] p-5 sm:p-8 shadow-sm">
            <div>
              <h2 className="text-center text-3xl sm:text-4xl font-black tracking-tight text-slate-900">Resume AI</h2>
              <p className="mt-2 text-center text-sm font-medium text-slate-600">Create your account</p>
            </div>
            ...
            <>
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-[#f3f7f4] px-3 text-slate-500">Or register with email</span>
                </div>
              </div>
            </>
